...
# from utils.constants import MUTIVARIATE_ARCHIVE_NAMES as MUTIARCHIVE_NAMES
...
def create_classifier(classifier_name, input_shape, nb_classes, output_directory,
    ...
    if classifier_name == 'nne':
        ...
        return nne.Classifier_NNE(output_directory, input_shape, archive_name,
                                  nb_classes, verbose)
...
if sys.argv[1] == 'InceptionTime':
    ...
    # this part is for running inception with the different hyper_parameters
        ...
        for xp_val in xp_arr:
            ...
            for iter in range(max_iterations):
                ...
                classifier = inception.Classifier_INCEPTION(output_directory, input_shape, nb_classes,
                                                                verbose=False, build=True, **kwargs)  #双星号传入map
    ...
    for xp in xps:
        ...
        for xp_val in xp_arr:
            ...
            classifier = nne.Classifier_NNE(output_directory, x_train.shape[1:],
                                                nb_classes, archive_name, clf_name=clf_name)
