...
class Classifier_NNE:
    ...
    def __init__(self, output_directory, input_shape, nb_classes, archive_name, verbose=False, nb_iterations=5,
                 clf_name='inception'):
        ...
        for model_name in self.classifiers:
            ...
            for itr in self.iterations_to_take:
                ...
                if check_if_file_exits(predictions_file_name):
                    ...
                    curr_y_pred = model.predict(x_test, y_true, return_df_metrics=False)
